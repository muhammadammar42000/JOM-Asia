...
const NationalParkPopup = ({setPopUpNational, PopUpNational}) => {
  ...
  return (
    <div>
       <div className={PopUpNational ? "addeditor_popup addeditor_popup_active" : "addeditor_popup"}>
            <div className="addeditor_popup_inner" id='style-3'>
                <div className='container'>
                    <div className='main_heading'>
                        <div>Add National Park</div>
                        <i className="fa fa-times cross" onClick={() =>setPopUpNational(false)}></i>
                    </div>
...
export default NationalParkPopup